  ...
  return (
    <div className={'work_one_man_studio_for_games'}>
      <div className={'texts'}>
        ...
        <p>
          Depuis mon enfance, je suis passionné par les jeux vidéo. J'ai toujours voulu créer les miens. C'est pourquoi
          je me suis lancé dans la création de mon propre studio de jeu vidéo indépendant pour y développer mes propres
          envies.
          <br />
          <br />
      ...
      <div className={'image'}>
        <a href="https://onemanstudioforgames.com">
          <img src={'/works/OneManStudio.png'} alt={'One Man Studio For Games'} />
        </a>
      </div>
    </div>
  );
